<form action="user-infos" method="post" class="<?= isset($in_edition) && $in_edition ? null : 'hidden'  ?> uk-margin-small-top">
    ...
    <div class="uk-grid uk-grid-small" uk-grid>
        ...
        <div class="uk-width-1-1@m">
            ...
            <div class="">
                <?= $Form->input('details',array('type'=>'textarea','__required'=>'required', 'style'=>'height:100px', 'class'=>"editeur_parcour uk-input _uk-form-large", 'placeholder'=>"Détails")) ?>
            </div>
        </div>
    ...
    <br>
    <button class="uk-input btn_gradient btn_connexion uk-text-uppercase uk-width-1-3@m" type="submit" name="submit_parcours">Enregistrer</button>
...
<script> 
        ClassicEditor
        .create( document.querySelector( '.editeur_parcour' ) )
        .catch( error => {
            console.error( error );
        } );
</script>