    ...
    <div class="uk-container">
        ...
        <div class="uk-grid-small _uk-child-width-expand@s" uk-grid>
            <div class="uk-width-3-4@m uk-padding-large">
                ...
                <div class="" style="margin-bottom: 50px; padding-bottom:50px; border-bottom: 1px solid #ddd">
                    <div class="content_img_projet">
                        <div class="image_projet">

                            <?php if(!empty($contenu['image'])) : ?>    
                                <img class="image" src="<?= RACINE ?>/admin/thumb.php?src=<?= $images_dir.$contenu['image'] ?>&w=430&h=220&a=cc&q=100" alt="" width="100%">
                            <?php endif; ?> 
                    ...
                    <div class="">
                        ...
                        <hr>                    
                        <div>
                            <?= tronquerTexte(strip_tags($contenu['description_fr']),370,'...') ?>
                        </div>

                        <div class="uk-grid-small uk-child-width-expand@s" uk-grid>
                            <div>
                                <br>
                                <a class="uk-button uk-button-default btn-rond" href="<?= $contenu['permalien'] ?>">Voir plus</a>
                            </div>
                            <div class="uk-text-right">
                                <br>
