<form action="user-infos" method="post" class="<?= isset($in_edition) && $in_edition ? null : 'hidden'  ?> uk-margin-small-top">
    ...
    <div class="uk-grid uk-grid-small" uk-grid>
        ...
        <div class="uk-width-1-2@m">
            <label class="uk-form-label" for="form-stacked-text">Langue</label>
            <div class="">
                <?= $Form->listeItems('id_langue', '',$liste_langues,1,array('class'=>'uk-select uk-form-large', 'required'=>'required')); ?>
            </div>
        </div>
    ...
    <br>
    <button class="uk-input btn_gradient btn_connexion uk-text-uppercase uk-width-1-3@m" type="submit" name="submit_langues">Enregistrer</button>
