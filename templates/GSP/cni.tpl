    ...
    <div class="uk-padding">
        ...
        <div >
            ...
            <div class="wrap_form relative uk-padding-large uk-text-center">
                ...
                <!--<a href="generator?id_current=1" class="uk-button button button_noir uk-width-small">reload</a>-->
                ...
                <div class="uk-switcher">
                    <div class="uk-text-center" >
                        ...
                        <img src="images/pics/final_<?= $data['image'] ?>" alt="" class="" width="100%">
                ...
                <br>
                    <br>
                    <em class="uk-width-1-1 uk-flex-center">Ceci est un hommage à Dj Arafat. Cette CNI et ce passeport ne sont en aucun cas liés à la vraie République populaire de Chine</em>
            </div>
