    ...
    <div class="uk-grid-match " uk-grid>
        ...
        <div class="uk-width-1-1@m ">
            ...
            <div class="uk-padding-remove-vertical footer_btn">
                ...
                <a href="parc?type=reseaux" class="uk-button uk-button-secondary btn_orange uk-margin-right">Réseaux d'affichage</a>
            </div>

            <div class="uk-padding-remove-vertical footer_btn">
                <br>
                <button class="uk-button uk-button-secondary btn_gris new_element" uk-toggle="target: #form_ecran">Ajouter un Réseau d'affichage</button>
            </div>
                    ...
                    <table class="uk-table uk-table-middle uk-table-divider uk-table-striped uk-text-small datatable">
                        <thead>
                            <tr>
                                ...
                                <th>Informations</th>                            
                                <th>Statut</th>
                                <th class="uk-text-center">Groupes</th>
                                <th class="uk-text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $i = 1; foreach($reseaux_groupes as $k=>$v) : ?>
                            <tr>
                                <td><?= $i ?></td>
                                <td>
                                    <div class="uk-width-1-1@m uk-text-center relative uk-margin-small-bottom bloc_item">
                                        <span uk-icon="icon: rss; ratio: 5"></span>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php if(!empty($v['groupes'])) : ?>

                
                                        <?php foreach($v['groupes'] as $y=>$z) : ?>
                                ...
                                <td class="uk-text-left">
                                    <div class="td_inner_menu">
                                        <a href="edit-element?id=<?= $v['id'] ?>&table=reseaux" uk-toggle="target: #form_ecran" class="edit_ecran"><span uk-icon="icon: file-edit;"></span> Modifier</a>
                                        <br>
                                        <a href="#" data-deleteUrl="/delete-element?delete=<?= $v['id'] ?>&table=reseaux" class="to_delete"><span uk-icon="icon: close;"></span> Supprimer</a>
                                        <br>
                                        <a href="planning?type=reseaux&cible=<?= $v['id'] ?>"><span uk-icon="icon: calendar;"></span> Plannifier</a>
                                    </div>
                                </td>
                            </tr>
                            <?php $i++; endforeach; ?>
    ...
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
        ...
        <form method="post" class="uk-text-center">
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin">
                    <p>Editer un Réseau d'affichage ?</p>
                </div> 

                <div class="uk-margin uk-text-left">
                    <label class="uk-form-label" for="form-stacked-text">Nom du réseau</label>
                    <input type="text" class="uk-input uk-border-rounded" name="libelle_fr" placeholder="Nom du réseau" id="libelle_fr" required>
                </div> 

                <div class="uk-margin uk-text-left">
                    <select multiple="multiple" name="groupes[]" id="example">
                        
                        <?php if(!empty($liste_groupes_ecrans2)) : ?>
                            <?php foreach ($liste_groupes_ecrans2 as $k => $v) : ?>
                ...
                <div class="uk-margin">
                    <button class="uk-button uk-button-primary _uk-button-small btn_orange" name="create_reseau" >Confirmer</button>
                </div>
