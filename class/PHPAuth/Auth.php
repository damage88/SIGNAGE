...
class Auth
{
	...
	*/
	...
	public function __construct(\PDO $dbh, $config, $language = "fr_FR")
	{
		$this->dbh = $dbh;
		$this->config = $config;
	...
	*/
	...
	public function isLogged() {
		return (isset($_COOKIE[$this->config->cookie_name]) && $this->checkSession($_COOKIE[$this->config->cookie_name]) && isset($_SESSION['auth']));
	}
