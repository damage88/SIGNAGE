...
function listeDemandes(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$liste_pays,$liste_villes,$type,$hierarchie,$services_proposes, $Model;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Gestion des <font color="#0076cc">Demandes</font> de service</h1>';
		...
		$html .= '<div class="content-in">';
	  	...
	  	$html .= '<table class="tableau-liste" id="datatable">';
			...
			foreach($data['reponse'] as $el){
				$user = $Model->extraireChamp('*','users','id='.$el['id_user']);
					...
					$html .= '<tr id="row_'.$el['id'].'">';
						...
						//$user_log = $temp;
						$html .= '<td class="center" '.$style.'>'.($user['image']?'<img src="thumb.php?src='.$images_dir.'/'.$user['image'].'&w=50&h=50" >':'<img src="thumb.php?src=img/no_pic.png&w=80&h=80" width="50" height="50">').'</td>';
						//$html .= '<td class="center orange">'.formatDate($el['date_pub'],'%d %B %Y').'</td>';
						$html .= '<td class="">'.strtoupper($user['nom'].' '.$user['prenoms']).'<br>'.$user['job_title'].'</td>';
						$html .= '<td class="center">'.strtoupper($user['societe']).'</td>';




						$html .= '<td class="center">'.$user['email'].'<a href="#"></a></td>';
						$html .= '<td class="center">'.$user['indicatif'].' '.$user['phone'].'<a href="#"></a></td>';
						$html .= '<td class="center">'.formatDate($el['date_enreg'],'%d %B %Y').'</td>';
...
function listeEventCandidats(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$pays,$villes,$type,$hierarchie, $current_event, $niveaux,$expertises,$domaines,$experiences;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Candidats participants pour  <font color="#0076cc">'.$current_event['libelle_fr'].'</font></h1>';
 			
 		$html .= '</div>';
		//$html .= '<hr>';
		$html .= '<div class="menu-action">';
			
			$html .= '<a class="bouton lien_ajax" href="admin_articles.php?action=liste&id_parent=15&'.$Session->csrf().'" data-container="#content" ><i class="fa fa-undo"></i> retour aux events</a>';
		$html .= '</div>';
		//$html .= '<hr>';
		$html .= '<div class="content-in">';
	  	...
	  	$html .= '<table class="tableau-liste" id="datatable">';
	  		$html .= '<thead>';
	  			$html .= '<tr>';
				  	...
				  	$html .= '<th class="l50">Image</th>';
				  	$html .= '<th class="l200">Nom & Prénom(s)</th>';
				  	$html .= '<th class="l100">CV</th>';
				  	$html .= '<th class="l50">Email</th>';
				  	$html .= '<th class="l50">Téléphone</th>';
				  	$html .= '<th class="l50">Genre</th>';
				  	$html .= '<th class="l50">Domaine</th>';
				  	$html .= '<th class="l50">Niveaux</th>';
				  	$html .= '<th class="l50">Expertise</th>';
				  	$html .= '<th class="l50">Expérience</th>';
				  	$html .= '<th class="l50">Pays</th>';
				  	$html .= '<th class="l50">Ville</th>';
				  	$html .= '<th class="l50">Statut</th>';
				  	$html .= '<th class="l70">Actions</th>';  	
	  			$html .= '</tr>';
	  		$html .= '</thead>';
			...
			foreach($data as $el){
					$style = ($el['sexe'] == 'masculin' ? 'style="background:#48a4eb;color:#fff"' : ($el['sexe'] == 'feminin' ? 'style="background:#ec008c;color:#fff"' : null));
					...
					$html .= '<tr id="row_'.$el['id'].'">';
						...
						//$temp = $Model->extraireChamp('*','members_logs','id_user = '.$el['id'].' ORDER BY id DESC LIMIT 1');
						//$user_log = $temp;
						$html .= '<td class="center" '.$style.'><a target="_blank" href="/recruteur/resume?code='.$el['code'].'&'.$Session->csrf().'">'.($el['image']?'<img src="thumb.php?src='.$images_dir.'users_pics/'.$el['image'].'&w=50&h=50" >':'<img src="thumb.php?src=img/no_pic.png&w=80&h=80" width="50" height="50">').'</a></td>';
						//$html .= '<td class="center orange">'.formatDate($el['date_pub'],'%d %B %Y').'</td>';
						$html .= '<td class=""><a target="_blank" href="/recruteur/resume?code='.$el['code'].'&'.$Session->csrf().'">'.strtoupper($el['nom'].' '.$el['prenoms']).'</a></td>';

						$html .= '<td class="_center"><a href="/files/'.$el['fichier'].'"><i class="fa fa-file"></i> Télécharger</a></td>';



						$html .= '<td class="_center"><a href="mailto='.$el['email'].'">'.$el['email'].'</a></td>';
						$html .= '<td class="center">'.$el['indicatif'].' '.$el['phone'].'<a href="#"></a></td>';
						$html .= '<td class="center">'.$el['sexe'].'</td>';
						$html .= '<td class="center">'.$domaines[$el['domaine']].'</td>';
						$html .= '<td class="center">'.$niveaux[$el['niveau']].'</td>';
						$html .= '<td class="center">'.$expertises[$el['expertise']].'</td>';
						$html .= '<td class="center">'.$experiences[$el['exp_year']].'</td>';
						$html .= '<td class="center">'.$pays[$el['pays']].'</td>';
						$html .= '<td class="center">'.$villes[$el['ville']].'</td>';
...
function listeEventRecruteurs(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$pays,$villes,$type,$hierarchie, $current_event, $niveaux,$expertises,$domaines,$experiences;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Recruteurs participants pour  <font color="#0076cc">'.$current_event['libelle_fr'].'</font></h1>';
	  	...
	  	$html .= '<table class="tableau-liste" id="datatable">';
	  		$html .= '<thead>';
	  			$html .= '<tr>';
	  				$html .= '<th class="l30">ID</th>';
				  	$html .= '<th class="l50">Image</th>';
				  	$html .= '<th class="l200">Nom</th>';
				  	$html .= '<th class="l50">Email</th>';
				  	$html .= '<th class="l50">Téléphone</th>';
				  	$html .= '<th class="l50">Domaine</th>';
				  	$html .= '<th class="l50">Pays</th>';
				  	$html .= '<th class="l50">Ville</th>';
				  	$html .= '<th class="l300">Besoin</th>';
				  	$html .= '<th class="l50">Statut</th>';
				  	$html .= '<th class="l70">Actions</th>';  	
	  			$html .= '</tr>';
	  		$html .= '</thead>';
			...
			foreach($data as $el){
					...
					$html .= '<tr id="row_'.$el['id'].'">';
						...
						//$temp = $Model->extraireChamp('*','members_logs','id_user = '.$el['id'].' ORDER BY id DESC LIMIT 1');
						//$user_log = $temp;
						$html .= '<td class="center" ><a target="_blank" href="/recruteur/resume?code='.$el['code'].'&'.$Session->csrf().'">'.($el['image']?'<img src="thumb.php?src='.$images_dir.'users_pics/'.$el['image'].'&w=50&h=50" >':'<img src="thumb.php?src=img/no_pic.png&w=80&h=80" width="50" height="50">').'</a></td>';
						//$html .= '<td class="center orange">'.formatDate($el['date_pub'],'%d %B %Y').'</td>';
						$html .= '<td class=""><a target="_blank" href="/recruteur/resume?code='.$el['code'].'&'.$Session->csrf().'">'.strtoupper($el['nom']).'</a></td>';
						...
						$html .= '<td class="center">'.$pays[$el['pays']].'</td>';
						$html .= '<td class="center">'.$villes[$el['ville']].'</td>';
						$html .= '<td class="" style="font-style:italic"><i>'.$el['besoin'].'</i></td>';
...
function listePostulants(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$pays,$villes,$type,$hierarchie, $current_offre, $niveaux,$expertises,$domaines,$experiences;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Postulants pour <font color="#0076cc">'.$current_offre['libelle'].'</font></h1>';
 			
 		$html .= '</div>';
		//$html .= '<hr>';
		$html .= '<div class="menu-action">';
			
			$html .= '<a class="bouton lien_ajax" href="'.$_PAGE.'?action=liste&'.$Session->csrf().'" data-container="#content" ><i class="fa fa-undo"></i> retour aux offres</a>';
		$html .= '</div>';
		//$html .= '<hr>';
		$html .= '<div class="content-in">';
...
function listeOffres(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$parents,$niveaux,$expertises,$types_contrat,$domaines,$experiences,$sexes,$pays,$villes;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';
	  	...
	  	$html .= '<table class="tableau-liste" id="datatable">';
	  		$html .= '<thead>';
	  			$html .= '<tr>';
				  	...
				  	$html .= '<th class="l300">Entreprise</th>';
				  	$html .= '<th class="l200">Libellé</th>';
				  	$html .= '<th class="l200">Domaine</th>';
				  	$html .= '<th class="l200">Niveau</th>';
				  	$html .= '<th class="l200">Expertise</th>';
				  	$html .= '<th class="l200">Experience</th>';
				  	$html .= '<th class="l100">Postulants</th>';
				  	$html .= '<th class="l50">Statut</th>';
				  	$html .= '<th class="l70">Actions</th>';  	
	  			$html .= '</tr>';
	  		$html .= '</thead>';
			...
			foreach($data['reponse'] as $el){
					...
					$compte = get_postulation_count($el['id']);
					$entreprise = $Model->extraireChamp('*', 'users', 'id='.$el['id_user']);
					...
					$html .= '<tr id="row_'.$el['id'].'">';
						...
						$html .= '<td class=""><a target="_blank" href="/recruteurs/'.$entreprise['id'].'">'.($entreprise['image']?'<img src="thumb.php?src='.$images_dir.'users_pics/'.$entreprise['image'].'&w=60&h=60" >':'<img src="thumb.php?src=img/no_pic.png&w=60&h=60" width="60" height="60">').' <span style="display:inline-block; float-left">'.strtoupper($entreprise['nom']).'</span></a></td>';
						$html .= '<td class="">'.$el['libelle'].'</td>';
						$html .= '<td class="">'.$domaines[$el['domaine']].'</td>';
						$html .= '<td class="">'.$niveaux[$el['niveau']].'</td>';
						$html .= '<td class="">'.$expertises[$el['expertise']].'</td>';
						$html .= '<td class="">'.$experiences[$el['exp_year']].'</td>';

						$html .= '<td class="center actions">';
							$html .= '<a title="Voir les postulants" class="lien_ajax" href="'.$_PAGE.'?action=postulants&edit=&id_emploi='.$el['id'].'&'.$Session->csrf().'&lien_retour='.urlencode($_PAGE.'?action=form&edit='.$el['id'].'&'.$Session->csrf()).'" data-container="#content" ><i class="fa fa-list"></i> '.$compte.' Postulant(s)</a>';							
						$html .= '</td>';
		...
		$html .= '<div class="content-in">';
	  		...
	  		$html .= '<thead>';
	  			$html .= '<tr>';
				  	...
				  	if(isset($_GET['id_parent']) && $_GET['id_parent'] == 15){
			  			$html .= '<th class="l200">Candidats</th>';
			  			$html .= '<th class="l100">Recruteurs</th>';
				  	}
			...
			foreach($data['reponse'] as $el){
					...
					$compte = get_event_participation_count($el['id'],0);
					$compte2 = get_event_participation_count($el['id'],1);
					...
					$html .= '<tr id="row_'.$el['id'].'">';
						...
						if(isset($_GET['id_parent']) && $_GET['id_parent'] == 5){
							...
							$html .= '</td>';
					  		...
					  		if(isset($_GET['id_parent']) && $_GET['id_parent'] == 15){
					  			$html .= '<td class="center actions">';
									$html .= '<a title="Voir les candidats participants" class="lien_ajax" href="'.$_PAGE.'?action=candidats&edit=&id_event='.$el['id'].'&'.$Session->csrf().'&lien_retour='.urlencode($_PAGE.'?action=form&edit='.$el['id'].'&'.$Session->csrf()).'" data-container="#content" ><i class="fa fa-list"></i> '.$compte.' Candidat(s)</a>';							
								$html .= '</td>';

								$html .= '<td class="center actions">';
									$html .= '<a title="Voir les recuruteurs participants" class="lien_ajax" href="'.$_PAGE.'?action=recruteurs&edit=&id_event='.$el['id'].'&'.$Session->csrf().'&lien_retour='.urlencode($_PAGE.'?action=form&edit='.$el['id'].'&'.$Session->csrf()).'" data-container="#content" ><i class="fa fa-list"></i> '.$compte2.' Recruteur(s)</a>';							
								$html .= '</td>';
...
function listeMembres___(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$pays,$villes,$type,$hierarchie;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';
	  	...
	  	$html .= '<table class="tableau-liste" id="datatable">';
	  		$html .= '<thead>';
	  			$html .= '<tr>';
	  				$html .= '<th class="l30">ID</th>';
				  	$html .= '<th class="l50">Image</th>';
				  	$html .= '<th class="l300">Nom & Prénom(s)</th>';
				  	$html .= '<th class="l50">Email</th>';
				  	$html .= '<th class="l50">Téléphone</th>';
				  	$html .= '<th class="l50">Genre</th>';
				  	$html .= '<th class="l50">Pays</th>';
...
function listeMembres2(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$pays,$villes,$type,$hierarchie;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Gestion des <font color="#0076cc">Clients</font></h1>';
	  	...
	  	$html .= '<table class="tableau-liste" id="datatable">';
	  		$html .= '<thead>';
	  			$html .= '<tr>';
				  	...
				  	$html .= '<th class="l50">Image</th>';
				  	$html .= '<th class="l200">Nom & Prénom(s)</th>';
				  	$html .= '<th class="l100">Entreprise</th>';
				  	$html .= '<th class="l50">Email</th>';
				  	$html .= '<th class="l50">Téléphone</th>';
				  	$html .= '<th class="l50">Genre</th>';
				  	$html .= '<th class="l50">Pays</th>';
			...
			foreach($data['reponse'] as $el){
					...
					$html .= '<tr id="row_'.$el['id'].'">';
						...
						$html .= '<td class="_center">'.$el['societe'].'<a href="#"></a></td>';
						$html .= '<td class="_center">'.$el['email'].'<a href="#"></a></td>';
						$html .= '<td class="center">'.$el['indicatif'].' '.$el['phone'].'<a href="#"></a></td>';
						$html .= '<td class="center">'.$el['sexe'].'</td>';
						$html .= '<td class="center">'.$pays[$el['pays']].'</td>';
