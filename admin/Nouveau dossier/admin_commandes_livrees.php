...
$sql = "SELECT commandes.id, commandes.id_user, commandes.total, commandes.livraison, commandes.adresse, commandes.date_enreg, commandes.date_livraison, commandes.id_livreur,commandes.etat, commandes.paye, commandes.valid, commandes.statut,users.phone FROM commandes LEFT JOIN users ON users.id = commandes.id_user WHERE commandes.valid = 1 AND commandes.statut = 1 AND commandes.etat = 1 ORDER BY commandes.date_livraison DESC";
