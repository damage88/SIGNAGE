...
function formDemandes(){
	global $Session,$Form,$_PAGE,$i,$images_dir,$retour,$_ADMIN_ACTIVE_EDITOR,$_ADMIN_ALL_EDITOR,$categories,$chps_persos,$chps_persos_values_tab,$matieres,$classes,$chapitres,$Model,$classes_light, $types_travaux, $niveaux,$expertises,$types_contrat,$domaines,$experiences,$sexes,$pays,$villes,$services_proposes;
	/*********** PERMISSIONS *****************/
	if(isset($_GET['edit'])){
		if(empty($_GET['edit'])){
	...
	$html .= '<div class="container" action="'.$_PAGE.'">';
		$html .= '<div class="page-header">';
			...
			if(isset($_GET['id_parent']) && !empty($_GET['id_parent'])){
				...
				$html .= '<h1>'.(($Form->data['id'])?"Modifier une ":"Ajouter une ").'<font color="#0076cc">Demande</font></h1>';
			}
		...
		$html .= '<form id="formActualites" data-retour="" class="" action="'.$_PAGE.'?update='.$Form->data['id'].(isset($_GET['id_parent']) ? '&id_parent='.$_GET['id_parent'] : null).'&'.$Session->csrf().'" method="post" enctype="multipart/form-data" autocomplete="off">'; 
			...
			$user = $Model->extraireChamp('*','users','id='.$Form->data['id_user']);
		////$html .= '<span class="tab_title active" id="francais">Français</span>';	
			...
			$html .= '<div  class="tab_cadre" id = "cadre_francais" >';	
				...
				$html .= '<label for="inputemail" class="requis "><b>Client</b></label>';
				$html .= '<input type="text" class="l100p" value="'.strtoupper($user['nom'].' '.$user['prenoms']).'" disabled>';

				$html .= '<label for="inputemail" class="requis "><b>Société</b></label>';
				$html .= '<input type="text" class="l100p" value="'.strtoupper($user['societe']).'" disabled>';

				$html .= '<label for="inputemail" class="requis "><b>Email</b></label>';
				$html .= '<a class="l100p inline_block" style="border:1px solid #aaa; padding:10px; margin-bottom:10px; font-size:14px" href="mailto:'.($user['email']).'"><b>'.$user['email'].'</b> (<i>cliquez pour envoyer un mail</i>)</a>';

				$html .= '<label for="inputemail" class="requis "><b>Téléphone</b></label>';
				$html .= '<input type="text" class="l100p" value="'.($user['indicatif'].' '.$user['phone']).'" disabled>';
				

				$html .= $Form->listeItems('id_service','<b>Service demandé</b>',$services_proposes,1,array('disabled'=>'disabled','class'=>'l100p'));
				$html .= '<br>';

				
				$html .= '<label for="inputdescription_fr" class="requis "><b>Demande du client</b></label>';
				$html .= $Form->input('description_fr',array('disabled'=>'disabled','class'=>"l100p _editeur_small",'type'=>'textarea','rows' =>8));
				$html .= '<br>';
...
function formEvents(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$liste_pays,$liste_villes,$type,$hierarchie,$users, $categories_boutique, $couleurs, $marques, $etats;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Gestion des <font color="#0076cc">Candidats / Clients</font> - Events</h1>';
...
function formOffres(){
	global $Session,$Form,$_PAGE,$i,$images_dir,$retour,$_ADMIN_ACTIVE_EDITOR,$_ADMIN_ALL_EDITOR,$categories,$chps_persos,$chps_persos_values_tab,$matieres,$classes,$chapitres,$Model,$classes_light, $types_travaux, $niveaux,$expertises,$types_contrat,$domaines,$experiences,$sexes,$pays,$villes;;
	/*********** PERMISSIONS *****************/
	if(isset($_GET['edit'])){
		if(empty($_GET['edit'])){
			__PAGE_PERMISSION__ & ECRIRE_ARTICLE ? null : dieNoPermissions();
	...
	$id_parent = (isset($_GET['id_parent']) ? '&id_parent='.$_GET['id_parent'] : null);
	$id_du_parent = (isset($_GET['id_parent']) ? $_GET['id_parent'] : null);
	$tab_categories_particulieres = array();
	...
	$html .= '<div class="container" action="'.$_PAGE.'">';
		$html .= '<div class="page-header">';
			...
			if(isset($_GET['id_parent']) && !empty($_GET['id_parent'])){
				...
				$html .= '<h1>'.(($Form->data['id'])?"Modifier une ":"Ajouter une ").'<font color="#0076cc">Offres</font></h1>';
			}
		...
		////$html .= '<span class="tab_title active" id="francais">Français</span>';	
			...
			$html .= '<div  class="tab_cadre" id = "cadre_francais" >';	
				...
				$html .= $Form->listeItems('domaine','<b>Domaine</b>',$domaines,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= $Form->listeItems('niveau','<b>Niveau</b>',$niveaux,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= $Form->listeItems('expertise','<b>Expertise</b>',$expertises,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';
				
				$html .= $Form->listeItems('contrat','<b>Contrat</b>',$types_contrat,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= $Form->listeItems('exp_year','<b>Expérience</b>',$experiences,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= $Form->listeItems('sexe','<b>Genre</b>',$sexes,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= '<label for="inputemail" class="requis "><b>Titre de l\'offre</b></label>';
				$html .= $Form->input('libelle',array('required'=>'required','class'=>'l100p',/*'disabled'=>''*/)); 

				$html .= '<label for="inputdescription_fr" class="requis "><b>Description de L\'offre</b></label>';
				$html .= $Form->input('description',array('required__'=>'required','class'=>"l100p editeur_small",'type'=>'textarea','rows' =>8));
				$html .= '<br>';

				$html .= '<label for="inputdescription_fr" class="requis "><b>Profil du candidat</b></label>';
				$html .= $Form->input('profil',array('required__'=>'required','class'=>"l100p editeur_small",'type'=>'textarea','rows' =>8));
				$html .= '<br>';

				$html .= $Form->listeItems('pays','<b>Pays</b>',$pays,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= $Form->listeItems('ville','<b>Ville</b>',$villes,1,array('required_'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= '<label for="inputemail" class="requis "><b>Date limite</b></label>';
				$html .= $Form->input('date_limite',array('required'=>'required','type'=>"date",'class'=>'l100p',/*'disabled'=>''*/)); 
...
function formOffres2(){
	global $Session,$Form,$_PAGE,$i,$images_dir,$retour,$_ADMIN_ACTIVE_EDITOR,$_ADMIN_ALL_EDITOR,$types_contenu,$type, $categories, $types,$hierarchie,$grades,$medecins,$centres,$centre_choisi,$etats,$niveaux,$expertises,$types_contrat,$domaines,$experiences,$sexes,$pays,$villes;
	/*********** PERMISSIONS *****************/
	if(isset($_GET['edit'])){
		if(empty($_GET['edit'])){
			__PAGE_PERMISSION__ & ECRIRE_ARTICLE ? null : dieNoPermissions();
	...
	$html .= '<div class="container" action="'.$_PAGE.'">';
		$html .= '<div class="page-header">';
			$html .= '<h1>'.(($Form->data['id'])?"Modifier une ":"Ajouter une ").'<font color="#0076cc">Offre</font></h1>';
		$html .= '</div>';
		//$html .= '<hr>';
		$html .= '<div class="menu-action">';
		...
		//$html .= '<span class="tab_title active" id="francais">Français</span>';	
			...
			$html .= '<div class="content-in">';
				...
				$html .= '<label for="inputdescription_fr" class="requis "><b>Description de L\'offre</b></label>';
				$html .= $Form->input('description',array('required'=>'required','class'=>"l100p editeur_small",'type'=>'textarea','rows' =>8));
				$html .= '<br>';

				$html .= '<label for="inputdescription_fr" class="requis "><b>Profil du candidat</b></label>';
				$html .= $Form->input('profil',array('required'=>'required','class'=>"l100p editeur_small",'type'=>'textarea','rows' =>8));
				$html .= '<br>';

				$html .= $Form->listeItems('pays','<b>Genre</b>',$pays,1,array('required'=>'required','class'=>'l100p'));
				$html .= '<br>';

				$html .= $Form->listeItems('ville','<b>Genre</b>',$villes,1,array('required_'=>'required','class'=>'l100p'));
				$html .= '<br>';
...
function formEmplois(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$liste_pays,$liste_villes,$type,$hierarchie,$users, $categories_boutique, $couleurs, $marques, $etats;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Gestion des <font color="#0076cc">Offres</font> d\'emplois</h1>';
...
function formCandidats(){
	global $_PAGE,$Session,$data,$nbPages,$current,$epp,$count,$url,$link,$images_dir,$Model,$categories,$categories_light,$Form,$classes,$liste_pays,$liste_villes,$type,$hierarchie,$users, $categories_boutique, $couleurs, $marques, $etats;
 	$html  = '<div class="container" action="'.$_PAGE.'">';
 		$html .= '<div class="page-header">';

 			
				$html .= '<h1>Gestion des <font color="#0076cc">Candidats</font></h1>';
...
function formBabysitters(){
	...
	$html .= '<a class="fancybox" href="'.RACINE.'responsivefilemanager/dialog.php?type=2&field_id=inputimage&relative_url=1" type="button">Choisir</a>';
	$html .= '</div>';
	//$html .= '<br>';	
	/*****************************************/
	/******************************************/
...
function formRessources(){
	...
	$html .= $Form->input('libelle_fr',array('class'=>'l100p',)); 
				...
				$html .= '<a class="fancybox" href="'.RACINE.'responsivefilemanager/dialog.php?type=2&field_id=inputfichier&relative_url=1" type="button">Choisir</a>';
				$html .= '</div>';
				//$html .= '<br>';	
				/*****************************************/
				/******************************************/
	...
	$html .= '<div class="container" action="'.$_PAGE.'">';
		...
		//$html .= '<span class="tab_title active" id="francais">Français</span>';	
			...
			$html .= '</div>';*/
				...
				$html .= '<a class="fancybox" href="'.RACINE.'responsivefilemanager/dialog.php?type=2&field_id=inputvideo&relative_url=1" type="button">Choisir</a>';
				$html .= '</div>';
				//$html .= '<br>';	
				/*****************************************/
				/******************************************/
...
function formMembres(){
	...
	$html .= '<label for="inputemail" class="requis "><b>Fonction</b></label>';
	$html .= $Form->input('job_title',array(/*'required'=>'',*/'class'=>'l100p',/*'disabled'=>''*/)); 


	$html .= '<label for="inputemail" class="requis "><b>Description</b></label>';
	$html .= $Form->input('description',array('type'=>'textarea','class'=>'l100p', 'rows'=>'5',/*'disabled'=>''*/));	
...
function formArticles(){
	global $Session,$Form,$_PAGE,$i,$images_dir,$retour,$_ADMIN_ACTIVE_EDITOR,$_ADMIN_ALL_EDITOR,$categories,$chps_persos,$chps_persos_values_tab,$matieres,$classes,$chapitres,$Model,$classes_light, $types_travaux, $mes_zones, $villes, $pays;
	/*********** PERMISSIONS *****************/
	if(isset($_GET['edit'])){
		if(empty($_GET['edit'])){
			__PAGE_PERMISSION__ & ECRIRE_ARTICLE ? null : dieNoPermissions();
	...
	$id_parent = (isset($_GET['id_parent']) ? '&id_parent='.$_GET['id_parent'] : null);
	$id_du_parent = (isset($_GET['id_parent']) ? $_GET['id_parent'] : null);
	$tab_categories_particulieres = array(23,24,25,26,27);
		...
		////$html .= '<span class="tab_title active" id="francais">Français</span>';	
			...
			$html .= '<div  class="tab_cadre" id = "cadre_francais" >';	
				...
				$html .= '<div class="'. $class .'">';
					...
					$html .= $Form->listeItems('id_parent','<b>Categorie</b>',$categories,1,array('class'=>"l500 choix_module_parent inline_block choix_categorie_article js-select2 overide_select2_style")); 
				...
				if(isset($_GET['id_parent']) && $_GET['id_parent'] == 20){
					...
					$html .= $Form->listeItems('type','<b>Catégorie de texte</b>',$categories_texte,1,array('class'=>'l100p _choix_module_parent _inline_block _choix_categorie_article')); 
				}

				if(isset($_GET['id_parent']) && $_GET['id_parent'] == 25){
					$contributeurs = getAndFormatDatas($table = 'articles', $contrainte = 'id_parent = 24 AND valid = 1 AND statut = 1 ORDER BY id DESC', 'id', 'libelle_fr');
					$html .= $Form->listeItems('type','<b>Contibuteur</b>',$contributeurs,1,array('class'=>'l100p _choix_module_parent _inline_block _choix_categorie_article')); 
				}

				if(isset($_GET['id_parent']) && $_GET['id_parent'] == 23){
					...
					$html .= $Form->listeItems('type','<b>Catégories d\'outils</b>',$categories_outils,1,array('class'=>'l100p _choix_module_parent _inline_block _choix_categorie_article')); 
				}


				// types de casting
				if(isset($_GET['id_parent']) && $_GET['id_parent'] == 39){
					...
					$html .= $Form->listeItems('type','<b>Type de casting</b>',$types_casting,1,array('class'=>'l100p _choix_module_parent _inline_block _choix_categorie_article')); 
				}
			...
			$html .= '</div>';
				...
				$html .= '<div class="wrap_file">';
				$html .= $Form->input('image',array('class'=>'l345',/*'disabled'=>''*/)); 
				$html .= '<a class="fancybox edited2" href="'.RACINE.'responsivefilemanager/dialog.php?type=2&field_id=inputimage&relative_url=1" type="button">Choisir</a>';
				$html .= '</div>';
				//$html .= '<br>';	
				/*****************************************/
				/******************************************/
						...
						foreach ($chps_persos as $value) {
							if($value['type'] == 1){
								...
								$html .= '<div>';
									...
									$html .= '<div class="wrap_file">';
									$html .= '<input type="text" name="chps_persos_values[values][]" id="'.$value['name'].'" class="l180" style="display:inline_block;margin-right:0;" placeholder="" value="'.(!empty($chps_persos_values_tab[$value['id']]) ? $chps_persos_values_tab[$value['id']]['value'] : null).'">'; 
									$html .= '<a class="fancybox" href="'.RACINE.'responsivefilemanager/dialog.php?type=2&field_id='.$value['name'].'&relative_url=1" type="button">Choisir</a>';
									$html .= '</div>';
	...
	if(isset($_GET['id_parent']) && !empty($_GET['id_parent']) && empty($_GET['edit'])){
  	...
  	$html .= '<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.12/js/select2.full.min.js"></script>';   	 
  	$html .= '<script type="text/javascript" src="js/script.js"></script>';   	 
